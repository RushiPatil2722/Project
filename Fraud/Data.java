...
public class Data extends javax.swing.JDialog {
    ...
    public Data(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        paint_table();
        cod.prepareTable("SELECT * FROM person ORDER BY user_id", tabela);
    }
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        cod.prepareTable("SELECT * FROM person WHERE first_name LIKE '%" + txt_search.getText() + "%' OR last_name LIKE '%" + txt_search.getText() + "%' OR address LIKE '%" + txt_search.getText() + "%' ORDER BY user_id", tabela);
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        try {
            ...
            conecta.executeSQL("SELECT * FROM person WHERE user_id = '" + nome + "'");
            conecta.rs.first();
            id = conecta.rs.getInt("user_id");
            ...
            txt_office.setText(String.valueOf(conecta.rs.getString("address")));
            txt_phone.setText(String.valueOf(conecta.rs.getString("mobile")));
            txt_fb.setText(String.valueOf(conecta.rs.getString("email")));
            txt_insta.setText(String.valueOf(conecta.rs.getString("dob")));
            txt_linkedin.setText(String.valueOf(conecta.rs.getString("gender")));
            txt_github.setText(String.valueOf(conecta.rs.getString("username")));
